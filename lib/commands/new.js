 ...
 * @returns {*}
 */
module.exports.new = function(projName, stage, s3Bucket, region, notificationEmail, awsProfile, noExeCf) {

  // ASCII Greeting
  JawsCLI.ascii();

  return _promptUser(projName, stage, s3Bucket, region, notificationEmail, awsProfile)
